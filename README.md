...
Env Setup: Create an issue or DM/Email (if you know my email) to get .env credentials for database.


Test User:
```
admin : test@123 (grants all permission)
guest : test@12345 (limited permission)
```
